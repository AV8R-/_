...
function NinjaSlider(a) {
    ...
    var Gb = function(a) {
        ...
        ob = function() {
            ...
            p("sl-nl", e + b + ")", d, "li.sl-nl", c);
            p("sl-nr", f + b + ")", d, "li.sl-nr", c);
            if (a.c == "slide") {
                b = "100%";
                p("sl-cl2", d, f + b + ")", "li.sl-cl2", c);
                p("sl-cr2", d, e + b + ")", "li.sl-cr2", c);
                p("sl-nl2", e + b + ")", d, "li.sl-nl2", c);
                p("sl-nr2", f + b + ")", d, "li.sl-nr2", c)
            }
    ...
    var eb = function(l) {
            ...
            if (g.a) {
                ...
                if (g.a.insertRule && !p) {
                    ...
                    g.a.addRule("#" + a.b + " li[class*='sl-n']", "visibility:visible;", 0);
                    g.a.addRule("#" + a.b + " li[class*='ns-show']", "visibility:visible;", 0)
                } else {
                    S();
                    m(" li[class*='sl-n'] {opacity:1;}")
                }
